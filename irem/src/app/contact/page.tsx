        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-2xl mx-auto">
              ...
              Emlak ihtiyaçlarınız için buradayız.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Bize danışın ve emlak hizmetlerimiz hakkında bilgi almak veya randevu oluşturmak için 
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Finanskent Mah. Sarphan Finanspark<br />
                    A Blok No:32<br />
                    Ümraniye / İstanbul
                  </p>
                </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600 space-y-1">
                    ...
                    <p><span className="font-medium">Cumartesi:</span> Kapalı</p>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Ümraniye'de merkezi konumumuzda sizi ağırlamaktan mutluluk duyarız. 
          ...
          >
            <div className="aspect-video w-full">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3008.8234567890123!2d29.1234567!3d41.0234567!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDHCsDAxJzI0LjQiTiAyOcKwMDcnMjQuNCJF!5e0!3m2!1str!2str!4v1234567890123!5m2!1str!2str"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="p-6 bg-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Sarphan Finanspark</h3>
                  <p className="text-gray-600">Finanskent Mah. A Blok No:32, Ümraniye / İstanbul</p>
                </div>
                <a
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Emlak ihtiyaçlarınız için bize danışın, 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="mailto:turkiye@iremworld.com"
                className="inline-flex items-center px-8 py-3 border-2 border-white text-white rounded-lg font-medium hover:bg-white hover:text-primary-600 transition-colors"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
