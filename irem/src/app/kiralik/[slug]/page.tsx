...
export default function RentPropertyPage() {
  ...
  if (error || !property) {
    return <PropertyError error={error || "Property not found"} type="rent" />;
  }

  return (
    <main className="min-h-screen bg-gray-50">
      <PropertyHero property={property} type="rent" />
      <PropertyGallery images={property.images} />
      <div ref={contentRef}>
        <PropertyContent property={property} type="rent" isVisible={isVisible} />
      </div>
    </main>
  );
}
