...
const featuredProjects: FeaturedProject[] = [
  {
    ...
    description: "Kartal Sahili'nde denize sıfır ilk parselde yükselen projemiz, kesintisiz ada manzarası ile büyülüyor.",
    status: "Satışta",
    ...
    features: ["Denize Sıfır", "Ada Manzarası", "Yüzme Havuzu"],
    type: "project"
  },
  {
    id: "228",
    ...
    description: "Basin Ekspres'e yakın Bağcılar bölgesinde yer alan 2 konut blokundan oluşan modern geliştirme projesi.",
    status: "Satışta",
    price: "Fiyat için iletişime geçin",
    images: [
    ...
    features: ["Merkezi Konum", "Modern Tasarım", "216 Ünite"],
    type: "project"
  },
  {
    id: "227",
    ...
    description: "Su kenarında yeşil alanlar ve sosyal tesisler sunan eşsiz yaşam projesi.",
    status: "Satışta",
    price: "Fiyat için iletişime geçin",
    images: [
    ...
    features: ["Su Kenarı", "Yeşil Alanlar", "Tapu Hazır"],
    type: "project"
  },
  {
    id: "226",
    ...
    location: "Kağıthane, İstanbul",
    description: "20 yıl gelir garantisi sunan yeni nesil gayrimenkul yatırım modeli.",
    status: "Satışta",
    ...
    features: ["20 Yıl Garanti", "Levent Yakını", "Yüksek Getiri"],
    type: "project"
  }
];
