...
const banners = [
  {
    ...
    description: "Havuzlu, müstakil lüks villa yaşamı. Doğayla iç içe huzurlu bir yaşam.",
    image: "/uploads/banner-gallery-bg/banner-gallery (1).jpg",
    portfolioImages: [
  ...
  },
  {
    ...
    image: "/uploads/banner-gallery-bg/banner-gallery (2).jpg",
    portfolioImages: [
  ...
  },
  {
    ...
    image: "/uploads/banner-gallery-bg/banner-gallery (3).jpg",
    portfolioImages: [
  ...
  },
  {
    ...
    description: "Modern ve konforlu rezidans daireleri. Şehrin kalbinde lüks yaşam.",
    image: "/uploads/banner-gallery-bg/banner-gallery (4).jpg",
    portfolioImages: [
...
export default function BannerGallery() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      nextBanner();
    }, 6000); // Banner changes every 6 seconds
            ...
            >
              ...
              <div className="relative group">
                ...
                <div className="relative w-[480px] lg:w-[576px] h-72 lg:h-[360px] rounded-2xl overflow-hidden shadow-xl bg-white/3 backdrop-blur-sm border border-white/5" style={{
                  ...
                  >
                    <Image
                      src={banners[currentBanner].portfolioImages[0]}
