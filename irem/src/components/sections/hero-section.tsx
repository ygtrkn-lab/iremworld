...
const SLIDES = [
  {
    ...
    gradient: "from-slate-900/40 via-gray-800/30 to-transparent",
  ...
  },
  {
    ...
    gradient: "from-teal-900/40 via-cyan-800/30 to-transparent",
  ...
  },
  {
    ...
    gradient: "from-indigo-900/40 via-purple-800/30 to-transparent",
  ...
  },
  {
    ...
    gradient: "from-rose-900/40 via-pink-800/30 to-transparent",
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-white text-sm font-medium drop-shadow-lg">
                        {currentSlideData.type === 'rental-office' ? 'KİRALIK OFİS' : 
                         currentSlideData.type === 'rental-apartment' ? 'KİRALIK DAİRE' :
                         currentSlideData.type === 'sale-apartment' ? 'SATILIK DAİRE' : 
                         currentSlideData.type === 'sale-office' ? 'SATILIK OFİS' :
                         currentSlideData.type === 'housing-projects' ? 'KONUT PROJESİ' :
                         currentSlideData.type === 'land' ? 'SATILIK ARSA' :
                         currentSlideData.type === 'villa' ? 'SATILIK VİLLA' : 'EMLAK'}
                      </span>
                    </div>
                    ...
                    <div className="space-y-4">
                      <h4 className="text-white text-lg font-semibold">
                        {currentSlideData.type === 'rental-office' ? 'Kiralık Ofis' : 
                         currentSlideData.type === 'rental-apartment' ? 'Kiralık Daire' :
                         currentSlideData.type === 'sale-apartment' ? 'Satılık Daire' : 
                         currentSlideData.type === 'sale-office' ? 'Satılık Ofis' :
                         currentSlideData.type === 'housing-projects' ? 'Konut Projesi' :
                         currentSlideData.type === 'land' ? 'Arsa' :
                         currentSlideData.type === 'villa' ? 'Satılık Villa' : 'Emlak'}
                      </h4>
